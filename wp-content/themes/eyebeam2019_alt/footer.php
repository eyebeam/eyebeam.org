		...
		<div class="logos">
			...
			<div id="partners">
				...
				<img src="<?php eyebeam2018_img_src('img/partners/atlantic-foundation.png'); ?>" alt="Atlantic Foundation" width="auto">
				<img src="<?php eyebeam2018_img_src('img/partners/capital-one.png'); ?>" alt="Capital One" class="offset" width="auto">
				<img src="<?php eyebeam2018_img_src('img/partners/craig-newmark.png'); ?>" alt="Capital One" width="auto">
				<img src="<?php eyebeam2018_img_src('img/partners/hyde-watson.png'); ?>" alt="The Hyde and Watson Foundation" width="auto">
				<img src="<?php eyebeam2018_img_src('img/partners/jerome.png'); ?>" class="offset" alt="Jerome Foundation" width="auto">
				<img src="<?php eyebeam2018_img_src('img/partners/macarthur-foundation.png'); ?>" alt="MacArthur Foundation" width="auto">
				<img src="<?php eyebeam2018_img_src('img/partners/nea-white.png'); ?>" class="offset" alt="National Endowment for the Arts" width="auto">
