		...
		<footer>
			...
			<div class="bottom">
				<div class="address">
					185 Wythe Ave, Office F1<br />
					Brooklyn, NY 11249-3120<br />
					<a href="https://goo.gl/maps/VMBopbEk3UkdGYvcA" alt="View this address on google maps">View on Map</a>
				</div>
				<div class="contact">
					<a href="tel:13473789163" class="phone" alt="Eyebeam Phone Number">+1 347.378.9163</a>
					<a href="mailto:info@eyebeam.org" class="email" alt="Eyebeam Email">info@eyebeam.org</a>
					<a href="https://twitter.com/eyebeamnyc" alt="Eyebeam on Twitter">@eyebeamnyc</a>
					<a href="https://www.eyebeam.org/" alt="Eyebeam Website">eyebeam.org</a>
				</div>
				<div class="social">
